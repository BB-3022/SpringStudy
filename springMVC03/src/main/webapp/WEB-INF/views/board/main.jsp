...
<body>
   ...
   <div class="container">
   <jsp:include page="/controller/common/header.jsp"></jsp:include>
     <h2>Spring MVC03</h2>
         ...
         listHtml += "<tr id ='c" +    obj.idx +"' style = 'display :none'>";
            ...
            listHtml += "<td colspan ='4'>";
               listHtml += "<textarea id='ta"+ obj.idx+"' readonly style = 'resize:none' rows='7' class ='form-control'>";   
                  ...
                  //수정 삭제 화면
                  //조건문안에서 EL식을 쓰고 싶다면 문자열로 감싸줘야 한다.
                  if("${mvo.memID}" == obj.memID){
                	  ...
                	  listHtml += "<br>";
	                  listHtml += "<span id ='ub"+obj.idx+"'>";
	                  listHtml +="<button disabled onclick='goUpdateForm("+obj.idx+")' class = 'btn btn-primary btn-sm'>수정화면</button></span> &nbsp"
	                  listHtml +="<button disabled onclick='goDelete("+obj.idx+")' class = 'btn btn-warning btn-sm'>삭제</button> &nbsp"
                  }
