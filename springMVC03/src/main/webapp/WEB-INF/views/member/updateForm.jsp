				...
				<%-- <input type="hidden" name="memProfile" value="${mvo.memProfile}"> --%>
					...
					<table style="test-align: center; border : 1px solid #dddddd" class="table table-bordered">
						...
						<tr>
							...
							<td colspan="2"><input type="password" requried="requried" onkeyup="passwordCheck()" name="memPassword1" id="memPassword1" class="form-control" maxlength="20" placeholder="비밀번호를 입력하세요."></td>
						</tr>
						...
						<tr>
							...
							<td colspan="2"><input type="text" value="${mvo.memName}" id="memName" name="memName" class="form-control" maxlength="20"></td>
						</tr>
						
						<tr>
							<td style="width:110px; vertical-align:middle;">나이</td>
							<td colspan="2"><input type="number" required=""required value="${mvo.memAge}" name="memAge" id="memAge" class="form-control" maxlength="20" placeholder="나이를 입력하세요"></td>
						</tr>
						...
						<tr>
							...
							<td colspan="2"><input type="email" name="memEmail" value="${mvo.memEmail}" id="memEmail" class="form-control" maxlength="50" placeholder="이메일를 입력하세요"></td>
						</tr>
